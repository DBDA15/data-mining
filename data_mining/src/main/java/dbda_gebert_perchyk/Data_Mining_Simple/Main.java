...
public class Main {
	public static void main(String[] args) {
		...
		SparkConf sparkConf = new SparkConf().setAppName(Main.class.getName());
		...
		System.out.println("note: the covariances for words that never occured together are omitted.");
		for (Tuple2<Set<String>, Float> entry : covariances.collect()) {
